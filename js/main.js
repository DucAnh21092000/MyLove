...
setInterval(() => {
    canvas.classList.toggle('animation')
    canvas.classList.toggle('animation2')
    mess.classList.toggle('animation3')
    mess.classList.toggle('animation4')
...
(function (canvas) {
    ...
    var image = (function () {
        ...
        function to(t) {
            ...
            point.x = settings.particles.size / 2 + point.x * settings.particles.size / 370;

            point.y = settings.particles.size / 2 - point.y * settings.particles.size / 370;
